<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg"><?php print "<b>".$item->title."</b>"; ?> Kaydını Düzenliyorsunuz..
            <a href="" class="btn btn-outline btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> Yeni Haber Ekle</a>
        </h4>
    </div>
    <div class="col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <form action="<?php print base_url("news/update/$item->id") ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div id="control-demo-6" class="">
                            <select class="form-control news_types" name="news_type">
                                <option value="images" <?php if ($item->news_type === "images"){print "selected";} ?>>Resim</option>
                                <option value="video" <?php if ($item->news_type === "video"){print "selected";} ?>>Video</option>
                            </select>
                        </div>
                    </div><!-- .form-group -->
                    <?php if ($item->news_type === "images"){ ?>
                        ...
                        <div class="form-group video_upload_container" style="display: none;">
                            <label for="exampleInputEmail1">Video URL</label>
                            <input type="text" class="form-control" name="video-url" placeholder="<?php print $item->video_url; ?>">
                        </div>
                    <?php }else if ($item->news_type === "video"){ ?>
                        <div class="row image_upload_container" style="display: none;">
                            <div class="col-md-1">
                                <img class="img-responsive" src="<?php print base_url("uploads/$viewFolder/$item->img_url"); ?>">
                            </div>
                            <div class="col-md-9 form-group image_upload_container">
