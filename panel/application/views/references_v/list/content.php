<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">Haberler Listesi
            <a href="<?php print base_url("news/new_form") ?>" class="btn btn-outline btn-primary btn-sm pull-right"><i
                        class="fa fa-plus"></i> Yeni Haber Ekle</a>
        </h4>
    </div>
    <div class="col-md-12">
            ...
            <?php } else { ?>
                ...
                <div class="table-responsive table-middle">
                    <table class="table table-hover table-striped content-container">
                        ...
                        <tbody class="sortable" data-url="<?php print base_url("news/rankSetter"); ?>">
                        <?php foreach ($items as $item) { ?>
                            ...
                            <tr id="ord-<?php print $item->id; ?>">
                                ...
                                <td><?php print $item->news_type; ?></td>
                                <td><?php if ($item->news_type == "images") {?>
                                ...
                                <?php }else if($item->news_type == "video"){ ?>
                                    <iframe
                                            height="100"
                                            src="<?php print $item->video_url; ?>"                                            >
                                    </iframe>
                                <?php } ?>
                                </td>
                                <td>
                                    <input class="isActive"
                                           data-url="<?php print base_url("news/isActiveSet/$item->id") ?>" id=""
                                           type="checkbox" data-switchery
                                           data-color="#10c469" <?php print ($item->isActive) ? "checked" : ""; ?> />
                                </td>
                                <td>
                                    <button data-url="<?php print base_url("news/delete/$item->id") ?>"
                                            class="btn btn-sm btn-outline btn-danger remove-btn"><i
                                                class="fa fa-trash"></i> Sil
                                    </button>
                                    <a href="<?php print base_url("news/update_form/$item->id") ?>"
