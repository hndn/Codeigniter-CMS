<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">Markalar Listesi
            <a href="<?php print base_url("brands/new_form") ?>" class="btn btn-outline btn-primary btn-sm pull-right"><i
                        class="fa fa-plus"></i> Yeni Marka Ekle</a>
        </h4>
    </div>
    <div class="col-md-12">
        <div class="widget p-lg">
            ...
            <?php if (empty($items)) { ?>
                ...
                <div class="alert alert-info text-center">
                    <p>Burada herhangi bir kayıt bulunamadı yeni marka ekleyerek bu sayfası doldurabilirsiniz..</p>
                </div>
            <?php } else { ?>
                ...
                <div class="table-responsive table-middle">
                    <table class="table table-hover table-striped content-container">
                        ...
                        <tbody class="sortable" data-url="<?php print base_url("brands/rankSetter"); ?>">
                            ...
                            <tr id="ord-<?php print $item->id; ?>">
                                ...
                                <td>
                                    <input class="isActive"
                                           data-url="<?php print base_url("brands/isActiveSet/$item->id") ?>" id=""
                                           type="checkbox" data-switchery
                                           data-color="#10c469" <?php print ($item->isActive) ? "checked" : ""; ?> />
                                </td>
                                <td>
                                    <button data-url="<?php print base_url("brands/delete/$item->id") ?>"
                                            class="btn btn-sm btn-outline btn-danger remove-btn"><i
                                                class="fa fa-trash"></i> Sil
                                    </button>
                                    <a href="<?php print base_url("brands/update_form/$item->id") ?>"
